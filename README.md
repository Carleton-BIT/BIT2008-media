...
2) Clone this repository with `git clone https://github.com/Carleton-BIT/BIT2008-media.git`
3) Open the repository with PyCharm. You can do this by going file->open and selecting the cloned folder called `BIT2008-media`
4) Configure your project interpreter. Go to file->settings, and selecting Python Interpreter under `Project: BIT2008-media`, and clicking Add Interpreter->Add Local Interpreter
...
9) In your project folder (BIT2008-media/studentdemo) create a file called `.env`
...
12) On the terminal, navigate to `BIT2008-media/studentdemo` and run `python manage.py migrate`
